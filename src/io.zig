...
const SCALAR_VTABLE = std.io.Reader.VTable{ .stream = Reader.stream_scalar };
const SSSE3_VTABLE = std.io.Reader.VTable{ .stream = Reader.stream_ssse3_multi_blocks };
...
pub const Reader = struct {
    ...
    pub fn init(blocks_reader: *std.io.Reader, scales_reader: *std.io.Reader, buffer: []u8, comptime endianness: std.builtin.Endian) Reader {
        ...
        return Reader{ .blocks_reader = blocks_reader, .scales_reader = scales_reader, .f32_block = undefined, .interface = interface };
    }
    ...
    fn stream_scalar(r: *std.io.Reader, w: *std.io.Writer, limit: std.io.Limit) std.io.Reader.StreamError!usize {
        ...
        mxfp4.dequantize.one_block(scale, self.blocks_reader.buffered()[0..mxfp4.BLOCK_BYTES_SIZE].*, &self.f32_block);
    ...
    fn stream_ssse3(r: *std.io.Reader, w: *std.io.Writer, limit: std.io.Limit) std.io.Reader.StreamError!usize {
        ...
        const f32_vector: @Vector(mxfp4.VALUES_PER_BLOCK, f32) = mxfp4.dequantize.one_block_ssse3(
            scale,
